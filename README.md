![docker image](https://github.com/Pepe-Marquez/nomad-efficiency-tables-image/actions/workflows/docker-publish.yml/badge.svg)
...
your `docker-compose.yaml` with `ghcr.io/Pepe-Marquez/nomad-efficiency-tables-image:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/Pepe-Marquez/nomad-efficiency-tables-image/manifests/main": unauthorized`
